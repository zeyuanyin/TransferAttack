...
# from scikit_opt.sko.tools import func_transformer
...
class GeneticAlgorithmBase(SkoBase, metaclass=ABCMeta):
    def __init__(self, func, n_dim,
        ...
        self.iter = 0
        self.crossover_Chrom  = None
        self.mutation_Chrom = None
    ...
    def run(self, max_iter=None):
        ...
        for i in range(self.max_iter):
            ...
            # print("iter:",i)
            # print("best score:")
            # print(self.Chrom[generation_best_index, :])
